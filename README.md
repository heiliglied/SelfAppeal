...
#### 작업환경 : Centos7 laravel5.6 php7.1 mysql5.7
...
```
```
#### 업무내용 : 임상시험재단 허브 플랫폼 사이트 제작.
#### 작업환경 : rocky linux 9, spring boot 2.7, mssql 12, mybatis
#### 작업내용 : 임상시험재단 사이트/관리자 작성.
  - 임상시험 자료 및 내부 데이터 데이터베이스 설계.
  - 임상시험 자료 업로드 프로세스 작성.
  - 임상시험 관련 자료 검색 프로세스 작성.
```
```
#### 업무내용 : 임상시험재단 통합 로그인 페이지 제작.
#### 작업환경 : rocky linux 9, spring boot 3.5, mssql 12, mybatis
#### 작업내용 : 임상시험재단 통합 로그인 사이트 작성.
  - 고유 키값을 이용한 콜백으로 통합 로그인 토큰 발급.
  - 소셜 로그인 연동으로 가입 프로세스 추가 작성.
```
